...
ENTRYPOINT_GUIDES: Final[dict[str, EntrypointGuide]] = {
    ...
    "write-implementation-prompt": EntrypointGuide(
        ...
        purpose="구현 지시서 작성",
        primary_documents=("write-implementation-prompt.md", "_implementation-rules.md", "_artifact-templates.md", "_approval-briefing-language.md", "_user-facing-language.md"),
        section_hints=(
            ...
            SectionHint("_approval-briefing-language.md", ("# Approval Briefing Language", "## 승인 전 브리핑 형식", "## 후속 작업 승인 요청 브리핑")),
            SectionHint("_user-facing-language.md", ("# User-Facing Language Layer", "## 기본 사용자 보고 금지 표현")),
        ),
    ...
    "cleanup-delete": EntrypointGuide(
        name="cleanup-delete",
        purpose="삭제와 정리 판단",
        primary_documents=("cleanup-delete.md", "_authority-boundary.md", "_approval-reference.md", "_approval-briefing-language.md", "_user-facing-language.md"),
        section_hints=(
            ...
            SectionHint("_approval-briefing-language.md", ("# Approval Briefing Language", "## 승인 전 브리핑 형식")),
    ...
    "verify-work": EntrypointGuide(
        name="verify-work",
        purpose="작업 결과 검증",
        primary_documents=("verify-work.md", "_implementation-rules.md", "_approval-briefing-language.md", "_user-facing-language.md"),
        section_hints=(
    ...
    "revise-work": EntrypointGuide(
        ...
        primary_documents=("revise-work.md", "verify-work.md", "_implementation-rules.md", "_approval-briefing-language.md", "_user-facing-language.md"),
        section_hints=(
    ...
    "complete-work": EntrypointGuide(
        ...
        primary_documents=("complete-work.md", "verify-work.md", "_artifact-templates.md", "_approval-briefing-language.md", "_user-facing-language.md"),
        section_hints=(
            ...
            SectionHint("_approval-briefing-language.md", ("# Approval Briefing Language", "## 후속 작업 승인 요청 브리핑")),
            SectionHint(
