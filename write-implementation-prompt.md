...
- 웹/모바일 UI 작업이면 FRONTEND_UX_CRITERIA, USER_FLOW 또는 INTERACTION_SPEC, DESIGN_SYSTEM 또는 UI_PATTERN, FRONTEND_ARCHITECTURE 또는 동등한 승인 문서가 requiredDocuments에 포함되어 있다.
...
- FRONTEND_UX_CRITERIA, USER_FLOW/INTERACTION_SPEC, DESIGN_SYSTEM/UI_PATTERN, FRONTEND_ARCHITECTURE 또는 동등한 승인 문서 없이 웹/모바일 UI의 route, page, component, layout, styling, motion, visual QA 기준을 포함하는 프롬프트를 만들지 마라.
