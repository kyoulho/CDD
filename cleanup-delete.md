...
분류 보고에는 각 후보의 이유, 현재 기준과의 충돌 여부, README/index 갱신 필요 여부, `_user-facing-language.md`의 "승인 전 브리핑 형식", 사용자 승인 문장을 포함한다. 승인 문장은 삭제/보존/비-SOT 표시의 목적, 포함 범위, 제외 범위, 되돌리기 어려운 위험, 승인 후 가능해지는 정리 작업을 브리핑한 뒤에만 제시한다.
